...
<body id="home" class="scrollspy">
  ...
  <section id="about" class="about scrollspy">
    <div class="container">
      <div class="row">
        <h3 class="center light black-text">Rugby|O</h3><br><br>
        <div class="col m6 s12 light">
          <p class="black-text">Rugby|O hadir dari hasil pemikiran anak bangsa, berdiri pada tanggal 23 April 2021.
        ...
        <div class="col m6 s12">
          <img src="../assets/logo/logo.jpg" width="350" class="responsive-img  materialboxed">
        </div>
      </div>
    </div>
    </div>
